...
//myArr.pop();//last index remove
// myArr.push("harry")//last index added
...
// Json
// obj = {name: "harry", length: 1, a: {this: 'tha"t'}}Y
...
//we can get the element by document.querySelector(".className");
